...
const CLASSES = {
    'Barbarian': {
        ...
        icon: <GiBullHorns style={{ color: 'Firebrick' }} />,
    },
    'Bard': {
    ...
    'Paladin': {
        ...
        icon: <GiCheckedShield style={{ color: 'DeepSkyBlue' }} />,
    },
    'Ranger': {
    ...
    'Rogue': {
        ...
        icon: <GiBroadDagger style={{ color: 'SlateGray' }} />,
    },
    'Sorcerer': {
    ...
    'Wizard': {
        ...
        icon: <GiSpellBook style={{ color: 'MediumVioletRed' }} />,
    },
};
