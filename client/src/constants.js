...
import { LuLeaf, LuScrollText } from 'react-icons/lu';
import { PiHandsPraying, PiShieldCheckeredFill, PiAxeBold } from 'react-icons/pi';
...
const CLASSES = {
    'Barbarian': {
        ...
        icon: <PiAxeBold style={{ color: 'Firebrick' }} />,
    },
    'Bard': {
        ...
        icon: <GiMusicalNotes style={{ color: 'pink' }} />,
    ...
    'Cleric': {
        ...
        icon: <PiHandsPraying style={{ color: 'white' }} />,
    ...
    'Fighter': {
        ...
        icon: <GiBroadsword style={{ color: 'gold' }} />,
    ...
    'Monk': {
        ...
        icon: <IoHandRightOutline style={{ color: 'LightGreen' }} />,
    },
    'Paladin': {
        ...
        icon: <PiShieldCheckeredFill style={{ color: 'DeepSkyBlue' }} />,
    },
    'Ranger': {
        ...
        icon: <TbBow style={{ color: 'SaddleBrown' }} />,
    },
    'Rogue': {
        ...
        icon: <GiPlainDagger style={{ color: 'SlateGray' }} />,
    },
    'Sorcerer': {
        ...
        icon: <VscFlame style={{ color: 'orange' }} />,
    },
    'Warlock': {
        ...
        icon: <GiEvilBat style={{ color: 'MediumSlateBlue' }} />,
    },
    'Wizard': {
        ...
        icon: <LuScrollText style={{ color: 'MediumVioletRed' }} />,
    },
};
